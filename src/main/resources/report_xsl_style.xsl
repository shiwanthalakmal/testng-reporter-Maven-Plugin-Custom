                        ...
                        <xsl:for-each select="$suiteElements">
							...
							<table>
								<tr>
									...
									<td  align="right" style="font-size: 14; width:5px; margin-top:20px;">
												<xsl:value-of
